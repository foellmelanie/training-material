...
key_points:
  ...
  - The **MSI Qualitycontrol** {% icon tool %} gives valuable information before starting the analysis.
  - The **MSI data exporter** {% icon tool %} can be used any time during the analysis when it is necessary to dig deeper into the data. Galaxy provides many text manipulation tools that can directly be applied on the exported tabular file to filter, sort, plot, ... the data.
contributors:
  - foellmelanie
  - bgruening
---
...
>
> 2. Download the imzML data from [Zenodo](https://zenodo.org/record/1560646) locally:
...
>    - {% icon param-file %} *"Sort Query"*: `MSI data exporter on data 1: spectra` (output of **MSI data exporter** {% icon tool %})
